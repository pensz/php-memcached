...
/* internal functions */
mmc_t *mmc_server_new(char *, int, unsigned short, int, int, int, char *, int TSRMLS_DC);
mmc_t *mmc_find_persistent(char *, int, int, int, int, char *, int TSRMLS_DC);
